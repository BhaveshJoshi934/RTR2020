...
void CreateWindow()
{
	...
	XStoreName(gpDisplay,gWindow,"Perspective Two 2D Shapes Texture in PP : Bhavesh Joshi!!");
...
//---------------------------------------------------------------------------------------------------------------
	...
	glGenBuffers(1,&vbo_pyramid_Texture_BDJ);
	glBindBuffer(GL_ARRAY_BUFFER,vbo_pyramid_Texture_BDJ);
	...
	glGenBuffers(1,&vbo_cube_Texture_BDJ);
	glBindBuffer(GL_ARRAY_BUFFER,vbo_cube_Texture_BDJ);
