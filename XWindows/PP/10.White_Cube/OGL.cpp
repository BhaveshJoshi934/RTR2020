...
//---------------------------------------------------------------------------------------------------------------
	...
	glGenBuffers(1,&vbo_cube_Color_BDJ);
	glBindBuffer(GL_ARRAY_BUFFER,vbo_cube_Color_BDJ);
...
void Draw(void)
{
	...
	modelViewMatrix = translateMatrix * scaleMatrix * rotateMatrix1 * rotateMatrix2 * rotateMatrix3;
