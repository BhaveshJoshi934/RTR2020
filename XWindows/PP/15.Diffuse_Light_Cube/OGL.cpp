...
GLuint vbo_pyramid_Color_BDJ;
*/
GLuint vao_cube_BDJ;
GLuint vbo_cube_Position_BDJ;
GLuint vbo_cube_Normal_BDJ;
...
void CreateWindow()
{
	...
	XStoreName(gpDisplay,gWindow,"Diffuse Light on Cube in PP : Bhavesh Joshi!!");
...
/*
	glGenVertexArrays(1,&vao_pyramid_BDJ);
	glBindVertexArray(vao_pyramid_BDJ);
	glGenBuffers(1,&vbo_pyramid_Position_BDJ);
	glBindBuffer(GL_ARRAY_BUFFER,vbo_pyramid_Position_BDJ);
	...
	glGenBuffers(1,&vbo_pyramid_Color_BDJ);
	glBindBuffer(GL_ARRAY_BUFFER,vbo_pyramid_Color_BDJ);
	...
	glBindVertexArray(0);
*/
	glGenVertexArrays(1,&vao_cube_BDJ);
	glBindVertexArray(vao_cube_BDJ);

	glGenBuffers(1,&vbo_cube_Position_BDJ);
	glBindBuffer(GL_ARRAY_BUFFER,vbo_cube_Position_BDJ);
	glBufferData(GL_ARRAY_BUFFER,sizeof(cubeVertices),cubeVertices,GL_STATIC_DRAW);
	glVertexAttribPointer(BDJ_ATTRIBUTE_POSITION,3,GL_FLOAT,GL_FALSE,0,NULL);
	glEnableVertexAttribArray(BDJ_ATTRIBUTE_POSITION);
	glBindBuffer(GL_ARRAY_BUFFER,0);

	glGenBuffers(1,&vbo_cube_Normal_BDJ);
	glBindBuffer(GL_ARRAY_BUFFER,vbo_cube_Normal_BDJ);
...
//	mat4 modelViewProjectionMatrix = mat4::identity();
	...
	mat4 rotateMatrix1 = vmath::rotate(cu_angle_BDJ,1.0f,0.0f,0.0f);
	mat4 rotateMatrix2 = vmath::rotate(cu_angle_BDJ,0.0f,1.0f,0.0f);
	mat4 rotateMatrix3 = vmath::rotate(cu_angle_BDJ,0.0f,0.0f,1.0f);
	...
	modelViewMatrix = translateMatrix * rotateMatrix1 * rotateMatrix2 * rotateMatrix3;
...
//--------------------------------------------------------------------------------------------
/*
	translateMatrix = vmath::translate(2.0f,0.0f,-4.0f);
...
/*
	...
	if(vbo_pyramid_Normal_BDJ)
	{
		glDeleteBuffers(1,&vbo_pyramid_Normal_BDJ);
		vbo_pyramid_Normal_BDJ = 0;
	}
*/
	...
	if(vbo_cube_Normal_BDJ)
	{
		glDeleteBuffers(1,&vbo_cube_Normal_BDJ);
		vbo_cube_Normal_BDJ = 0;
	}
