...
void Draw(void)
{
	static GLfloat tri_angle_BDJ = 0.0f;
	static GLfloat rect_angle_BDJ = 0.0f;
	...
	mat4 rotateMatrix = vmath::rotate(rect_angle_BDJ,1.0f,0.0f,0.0f);
...
//--------------------------------------------------------------------------------------------
	...
	rotateMatrix = vmath::rotate(tri_angle_BDJ,0.0f,1.0f,0.0f);
	...
	tri_angle_BDJ += 1.0f;
	if(tri_angle_BDJ >= 360.0f)
	{
		tri_angle_BDJ = 0.0f;
	}

	rect_angle_BDJ += 1.0f;
	if(rect_angle_BDJ >= 360.0f)
	{
		rect_angle_BDJ = 0.0f;
	}
