...
void Display()
{
    static GLfloat angle_triangle = 0.0f;
    static GLfloat angle_square = 0.0f;
    ...
    mat4 rotationMatrix = vmath::rotate((GLfloat)angle_triangle,0.0f,1.0f,0.0f);
    ...
    rotationMatrix = vmath::rotate((GLfloat)angle_square,1.0f,0.0f,0.0f);
    ...
    angle_triangle = angle_triangle + 0.1f;
    if(angle_triangle >= 360.0f)
    {
        angle_triangle = 0.0f;
    }

    angle_square = angle_square + 0.1f;
