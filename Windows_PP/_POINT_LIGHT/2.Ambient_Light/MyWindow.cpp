...
/*
    ...
    const GLchar *fragmentShaderSourceCode =
        ...
        "void main(void)" \
        "{" \
        "vec4 scatteredLight = u_Ambient;" \
        "FragColor = min(out_color * scatteredLight,vec4(1.0f));" \
        "}";
*/
//FragColor = min(out_color * scatteredLight,vec4(1.0f))
    ...
    const GLchar *fragmentShaderSourceCode =
        ...
        "void main(void)" \
        "{" \
        "vec3 scatteredLight = vec3(u_Ambient);" \
        "vec3 rgb = min(out_color.rgb * scatteredLight,vec3(1.0f));"
...
void Display()
{
    ...
    glUniform4fv(AmbientUniform,1,lightAmbient);
