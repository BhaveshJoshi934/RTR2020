...
int WINAPI WinMain(HINSTANCE hInstance,HINSTANCE hPrevInstance,LPSTR lpszCmdLine,int iCmdShow)
{
    ...
    hwnd = CreateWindowEx(WS_EX_APPWINDOW,
                          szAppName,
                          TEXT("Simple Smiley Texture in PP : Bhavesh Joshi !!"),
...
void Initialize()
{
    ...
    glBufferData(GL_ARRAY_BUFFER,sizeof(smileyTexCoord),smileyTexCoord,GL_STATIC_DRAW);
	...
	LoadGLTexture(&Smiley_Texture,MAKEINTRESOURCE(SMILEY_BITMAP));         //Texture Code
