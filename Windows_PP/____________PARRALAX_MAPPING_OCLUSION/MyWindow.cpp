...
int WINAPI WinMain(HINSTANCE hInstance,HINSTANCE hPrevInstance,LPSTR lpszCmdLine,int iCmdShow)
{
    ...
    hwnd = CreateWindowEx(WS_EX_APPWINDOW,
                          szAppName,
                          TEXT("Parallax OCLUSION Mapping : Bhavesh Joshi !!"),
...
void Initialize()
{
    ...
    //diffuseMap = loadTexture(".\\resources\\textures\\wood.jpg");
    //normalMap  = loadTexture(".\\resources\\textures\\toy_box_normal.jpg");
    //heightMap  = loadTexture(".\\resources\\textures\\toy_box_disp.jpg");
...
void Display()
{
    ...
    static GLfloat quad_angle = -90.0f;
    ...
    mat4 translateMatrix = vmath::translate(0.0f,-0.1f,-0.3f);
    mat4 scaleMatrix = vmath::scale(0.25f,0.25f,0.25f);
    mat4 rotateMatrix = vmath::rotate(quad_angle,1.0f,0.0f,0.0f);
    ...
    //quad_angle = quad_angle + 0.05f;
    if(quad_angle >= 360.0f)
    {
        quad_angle = 0.0f;
    }
