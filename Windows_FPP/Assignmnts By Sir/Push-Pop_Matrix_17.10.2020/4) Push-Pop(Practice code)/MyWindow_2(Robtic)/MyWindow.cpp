...
void Display(void)
{
	...
	//Draws the sphere of radius 0.5 slices=10 stacks=10
	//slices are number of subdivision around z-axis like longitude
	//stacks are number of subdivision along z-axis like latitude
	...
	glRotatef((GLfloat)fingure, 0.0f, 1.0f, 0.0f);
	...
	//Extracting Palm matrix and pushing the same
	glPopMatrix();
	glPushMatrix();
