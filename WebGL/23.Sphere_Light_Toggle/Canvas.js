...
//--------------------------------------------------------------------------------
	...
	gl.bindAttribLocation(shaderProgramObject_VS,WebGLMacros.BDJ_ATTRIBUTE_POSITION,"vPosition");
	gl.bindAttribLocation(shaderProgramObject_VS,WebGLMacros.BDJ_ATTRIBUTE_NORMAL,"vNormal");
...
//--------------------------------------------------------------------------------
	...
	gl.bindAttribLocation(shaderProgramObject_FS,WebGLMacros.BDJ_ATTRIBUTE_POSITION,"vPosition");
	gl.bindAttribLocation(shaderProgramObject_FS,WebGLMacros.BDJ_ATTRIBUTE_NORMAL,"vNormal");
...
if(bToggle == true)
{
	...
	if(bLight == true)
    {
        ...
        gl.uniform1f(KshineUniform_VS,MaterialShininess);      // Ithe Error Yeu Shakate
...
else
{
	...
	if(bLight == true)
    {
        ...
        gl.uniform1f(KshineUniform_FS,MaterialShininess);      // Ithe Error Yeu Shakate
