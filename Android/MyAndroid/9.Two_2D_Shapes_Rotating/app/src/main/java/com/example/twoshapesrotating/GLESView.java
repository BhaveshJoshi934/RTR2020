package com.example.twoshapesrotating;
...
public class GLESView extends GLSurfaceView implements GLSurfaceView.Renderer,OnGestureListener,OnDoubleTapListener
{
	...
	static float angle_rectangle = 0.0f;
	...
	{	
		...
		GLES32.glBindAttribLocation(shaderProgramObject,GLESMacros.BDJ_ATTRIBUTE_COLOR,"vColor");
		...
		FloatBuffer verticesBuffer_color = byteBuffer_color.asFloatBuffer();
		verticesBuffer_color.put(triangleColor);
		verticesBuffer_color.position(0);
	
		GLES32.glBufferData(GLES32.GL_ARRAY_BUFFER,	
				    triangleColor.length*4,	
				    verticesBuffer_color,
				    GLES32.GL_STATIC_DRAW);

		GLES32.glVertexAttribPointer(GLESMacros.BDJ_ATTRIBUTE_COLOR,
					     3,	
					     GLES32.GL_FLOAT,	
					     false,0,0);

		GLES32.glEnableVertexAttribArray(GLESMacros.BDJ_ATTRIBUTE_COLOR);
...
//---------------------------------------------------------------------------------------------------------------------
		...
		FloatBuffer verticesBuffer_rectangle = byteBuffer_rectangle.asFloatBuffer();
		verticesBuffer_rectangle.put(rectangleVertices);
		verticesBuffer_rectangle.position(0);
	
		GLES32.glBufferData(GLES32.GL_ARRAY_BUFFER,	
				    rectangleVertices.length*4,	
				    verticesBuffer_rectangle,
				    GLES32.GL_STATIC_DRAW);
		...
		GLES32.glVertexAttrib3f(GLESMacros.BDJ_ATTRIBUTE_COLOR,0.0f,0.0f,1.0f);
...
//---------------------------------------------------------------------------------------------------------------------
	...
	{	
		...
		Matrix.translateM(translateMatrix,0,1.8f,0.0f,-5.0f);
...
//---------------------------------------------------------------------------------------------
		...
		Matrix.translateM(translateMatrix,0,-1.8f,0.0f,-5.0f);
		Matrix.setRotateM(rotateMatrix,0,angle_rectangle,1.0f,0.0f,0.0f);
