...
public class GLESView extends GLSurfaceView implements GLSurfaceView.Renderer,OnGestureListener,OnDoubleTapListener
{
	...
	private int textureEnableUniform;
	...
	{	
		...
		textureEnableUniform = GLES32.glGetUniformLocation(shaderProgramObject,"u_texture_enable");
...
else
{
     textureEnable = 1;
		...
		GLES32.glUniform1i(textureEnableUniform, textureEnable);
